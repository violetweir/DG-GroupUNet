...
__all__ = ["UltraLight_VM_UNet", "UltraLightVMUNet"]


def _missing_mamba_error():
    return ImportError(
        "UltraLight_VM_UNet requires mamba_ssm. Use the dedicated VM-UNet environment "
        "with compatible Python, PyTorch, CUDA, causal_conv1d, triton, and mamba_ssm versions."
    )
...
UltraLightVMUNet = UltraLight_VM_UNet
